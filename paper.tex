...
All experiments run on an Apple M2 (8 cores, 16 GB RAM). Both algorithms are implemented in C++17 compiled with \texttt{clang++ -O3 -march=native}. The ILP uses HiGHS 1.10 as the MIP solver.
